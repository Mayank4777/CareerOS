...
class PublicationAPIViewTests(APITestCase):
    def test_crud_flow_and_validation(self) -> None:
        client = APIClient()
        list_url = reverse("publications:publication-list")
        ...
        detail_url = reverse("publications:publication-detail", kwargs={"publication_id": publication.id})
        other_detail_url = reverse("publications:publication-detail", kwargs={"publication_id": other_publication.id})
        ...
        create_response = client.post(
            ...
            data={
                ...
                "publication_url": "https://example.com/new-paper",
        ...
        update_response = client.patch(detail_url, data={"title": "Updated Paper"}, format="json")
        self.assertEqual(update_response.status_code, status.HTTP_200_OK)

        validation_response = client.post(
            list_url,
            data={"title": "", "publisher": "", "publication_date": "2024-01-01"},
            format="json",
        )
